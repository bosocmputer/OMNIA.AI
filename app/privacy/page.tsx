...
const DATA_ITEMS = [
  ...
  "ข้อมูลเจ้าชะตาแบบทดลอง เช่น ชื่อ/ชื่อเล่น วันเกิด เวลาเกิด สถานที่เกิด เรื่องที่อยากโฟกัส และบริบทล่าสุด ซึ่งเก็บชั่วคราวใน browser ของผู้ทดลองใช้",
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="grid gap-4 mt-5">
          ...
          <section className="rounded-2xl border p-6" style={{ borderColor: "var(--accent-30)", background: "var(--accent-8)" }}>
            <h2 className="text-lg font-bold mb-3">ข้อมูลทดลองใช้ฟรี</h2>
            <p className="text-sm leading-relaxed" style={{ color: "var(--text-muted)" }}>
              ผู้ที่ทดลองใช้โดยไม่สมัครสมาชิกสามารถถามฟรีได้ในจำนวนที่ระบบกำหนด หากคำถามเป็นเรื่องดูดวง ระบบอาจขอชื่อหรือชื่อเล่น วันเดือนปีเกิด เวลาเกิด สถานที่เกิด
              เรื่องที่อยากให้หมอดูจับก่อน และบริบทล่าสุด เพื่อให้คำตอบไม่กว้างเกินไป ข้อมูลชุดนี้เก็บชั่วคราวใน browser/localStorage ของเครื่องที่ใช้งาน
              และไม่ได้ถูกบันทึกเป็นโปรไฟล์เจ้าชะตาถาวรจนกว่าจะสมัครสมาชิกและบันทึกข้อมูลด้วยตนเอง
            </p>
          </section>
