...
**สถานะล่าสุด (29 เม.ย. 2569):** Soft launch/demo พร้อมใช้งาน ระบบดูดวง, privacy/terms/contact, analytics และ feedback พร้อมแล้ว โดยช่วง demo ปิดการหักเครดิตเพื่อให้ user ทดลองได้เต็มที่
...
ระบบ monetization ถูกพักไว้ระหว่าง demo (`CREDIT_BILLING_ENABLED` ไม่ได้ตั้งเป็น `true`) เพื่อให้ผู้ใช้ทดลองถามได้ฟรีก่อน หากพร้อมเปิดขายจริงให้ตั้ง `CREDIT_BILLING_ENABLED=true` แล้ว deploy ใหม่ ระบบเครดิตเดิมจะกลับมาใช้งาน:

| รายการ | เครดิต / ราคา | หมายเหตุ |
|--------|---------------|----------|
| เครดิตฟรีสมาชิกใหม่ | 29 เครดิต | ทดลองถามเร็ว 1 ครั้ง |
| ถามเร็ว | 19 เครดิต | หมอดู 1-2 ท่าน |
| สภา OMNIA | 49 เครดิต | หมอดู 3-5 ท่าน พร้อมสรุปรวม |
| ถามต่อ | 9 เครดิต | ต่อจากคำทำนายเดิม |
| Starter | 49 บาท / 80 เครดิต | เหมาะกับเริ่มลอง |
| Focus | 99 บาท / 190 เครดิต | แพ็กแนะนำช่วงเปิดตัว |
| Pro | 249 บาท / 560 เครดิต | เหมาะกับใช้บ่อย |
...
ระหว่าง demo ผู้ใช้ทั่วไปจะเห็น `Demo mode · ถามฟรี` และไม่ถูกพาไปเติมเครดิต
...
1. สมัคร user ใหม่
2. ถามเร็ว/ถามแบบสภา OMNIA ได้โดยไม่ต้องเติมเครดิต
3. ตรวจว่า sidebar และหน้า `/upgrade` แสดง Demo mode / ถามฟรี
4. เก็บ feedback เรื่องความแม่น ความยาว ความอ่านง่าย และราคา
5. หลัง demo หากจะเปิดเก็บเงินจริง ให้ตั้ง `CREDIT_BILLING_ENABLED=true`
6. ทดสอบ flow เครดิตอีกครั้ง: เครดิตฟรี, หักเครดิต, เติม PromptPay, admin อนุมัติ
